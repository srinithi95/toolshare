...
const registerUser = (req, res) => {
    ...
    let query = `insert into users (first_name, last_name, email, address, contact_number, password) values (?, ?, ?, ?, ?, ?);`
    ...
    con.query(query, [firstName, lastName, email, address, contactNumber, password]);
